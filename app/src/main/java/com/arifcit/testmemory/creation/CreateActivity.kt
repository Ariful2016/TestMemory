package com.arifcit.testmemory.creation
...
import com.arifcit.testmemory.R
import com.arifcit.testmemory.models.BoardSize
import com.arifcit.testmemory.utils.BitmapScaler
...
class CreateActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    supportActionBar?.title = "Select pics (0 / $numImagesRequired)"
    ...
    db.collection("games").document(customGameName).get().addOnSuccessListener { document ->
      if (document != null && document.data != null) {
        AlertDialog.Builder(this)
          .setTitle("Name taken")
          .setMessage("Game already exists with the name '$customGameName'. Please select another")
  ...
  private fun handleAllImagesUploaded(gameName: String, imageUrls: MutableList<String>) {
    db.collection("games").document(gameName)
      ...
      .addOnCompleteListener { gameCreationTask ->
        ...
        AlertDialog.Builder(this)
          .setTitle("Upload complete successfully! Let's play your game '$gameName'")
  ...
  private fun launchIntentForPhotos() {
    ...
    startActivityForResult(Intent.createChooser(intent, "Select pics"), PICK_PHOTO_CODE)
  }
}